...
AIntentorySystemCppCharacter::AIntentorySystemCppCharacter()
{
	...
	GetCapsuleComponent()->OnComponentBeginOverlap.AddDynamic(this, &AIntentorySystemCppCharacter::OnBeginOverlap);
...
void AIntentorySystemCppCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AIntentorySystemCppCharacter::Move);
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AIntentorySystemCppCharacter::Look);
		EnhancedInputComponent->BindAction(InventoryAction, ETriggerEvent::Started, this, &AIntentorySystemCppCharacter::ToggleInventory);
	}
	else
	{
...
void AIntentorySystemCppCharacter::OnBeginOverlap(UPrimitiveComponent* HitComp,
	AActor* OtherActor,
